...
.method protected getResponseData(Lorg/apache/http/HttpEntity;)[B
    ...
    .line 90
    invoke-virtual {p0, v5, v4}, Lcom/loopj/android/http/RangeFileAsyncHttpResponseHandler;->GetCrc16([BI)V
    :try_end_0
    ...
    :cond_0
    :try_start_1
    iget v6, p0, Lcom/loopj/android/http/RangeFileAsyncHttpResponseHandler;->crc:I

    invoke-virtual {p0, v6}, Lcom/loopj/android/http/RangeFileAsyncHttpResponseHandler;->sendCrcMessage(I)V
    :try_end_1
